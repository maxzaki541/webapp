        ...
        <div class="container my-4">
            <div class="row">
                <div class="mb-3 col-lg-12">
                    <div class="header">
                        เพิ่มข้อมูลการรักษา <?php echo $data22["Info_name"]." ".$data22["Info_surename"]; ?>
                    </div>
                </div>
            ...
            <form action="assets/php/add_history_medical.php" method="post" enctype="multipart/form-data">
                <div class="row my-4" style="padding: 50px">
                        ...
                        <input type="hidden" name="id" value="<?php echo $id; ?>" pattern="DE[0-9]{4}" required class="form-control">
